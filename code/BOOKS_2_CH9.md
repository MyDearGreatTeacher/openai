...
- 9-1 資金管理
  ...
  - 凱利公式 (Kelly formula)
  - 將凱利公式運用在股票回測中
- Google Colab 實戰9-2 投資組合資金分配與風險管理
  - 將凱利公式運用到投資組合配置
  - 投資組合風險指標
- Web AI投資分析師 ==> 9-3 讓 AI 來給出投資組合建議
...
# -*- coding: utf-8 -*-
"""AI投資分析師_20240521.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ODg_gTsnBbiU0oP3Xj3DaqGaARw-zuDa
...
if not os.path.exists(stock_db_path):
    print("下載資料庫中...")
    url = 'https://drive.google.com/uc?id=1S5JE9ZF2hohRpvO8FikgLhQmN2DJrVgW'
